...
module.exports = {
  up: (queryInterface, Sequelize) => {
      return queryInterface.bulkInsert('Areas', [
        ...
        { name: "Twenty Classics", elevation: "", stateId: 51 , parentId: null , approach: "Road Trip!", description: "Get out and do 'em!"},
